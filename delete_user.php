...
$parts = explode('/', $url);
$users = end($parts); // ID pengguna adalah elemen terakhir dalam array
...
$sql = "DELETE FROM users WHERE id = '$users'"; // Ganti 'users' dengan nama tabel Anda
if (mysqli_query($conn, $sql)) {
    echo "Pengguna dengan ID $users telah dihapus.";
} else {
